<template>
  ...
  <input class="form-check-input" v-model="per"  type="radio" name="inlineRadioOptions" id="inlineRadio1" value="0">
  <label class="form-check-label" for="inlineRadio1">Per Month</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" v-model="per"  type="radio" name="inlineRadioOptions" id="inlineRadio2" value="1">
  <label class="form-check-label" for="inlineRadio2">Per Year</label>
                ...
                <div class="col-lg-6 mb-2">
                  <div class="">
                     ...
                     <input type="text" class="form-control" v-model="job_timing_from">
                  </div>
               </div>
                 <div class="col-lg-6 mb-2">
                  <div class="">
                 ...
                 <div class="col-lg-12 mb-2">
                  ...
                  <div class="">
                     ...
                     <textarea v-model="description" class="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Write your message..." spellcheck="false"></textarea>
                  </div>
               </div>
                 ...
                 <div class="col-lg-12 mb-2">
                  <div class="">
                     ...
                     <input v-model="other_benefits" type="text" class="form-control">
                  </div>
               </div>
            ...
            <b-form-group  label-cols-sm="0" label-size="sm">
               ...
               <div class="col-lg-12">
                 <b-button type="submit" style="background-color: #004898!important" class="w-100 font-xsssss fw-700 ps-3  pe-3 lh-32  mt-1 mb-0  text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto">Job Create</b-button>
               </div>
            </div>
         </form>
      </div>
      ...
      showDismissibleAlert: false,
       ...
       async handalSubmit() {
          ...
          if(this.photo){
           ...
           const response = await axios.post("restaurants/job", 
              photo, {  onUploadProgress: uploadEvent =>{
