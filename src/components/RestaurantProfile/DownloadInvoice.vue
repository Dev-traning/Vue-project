      ...
      <div class="p-2 border-0 card-body w-100">
         <div class="m-1 row">
            <div class="col-md-7">
                ...
                <b-button type="submit" @click="DownloadInvoice()" :disabled="!isSubscribed" style=" font-size: 2vh; background-color: #004898!important" class="font-xsssss fw-700 ps-3 p-3 pe-3 lh-32  mt-1 mb-0  text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto" >
