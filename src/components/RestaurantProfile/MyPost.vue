...
<template >
   <div>
      <div class="p-4 mb-3 mt-3 border-0 card w-100 shadow-xss rounded-xxl" v-for="(item,itemIndex) in post" v-bind:key="item.id">
            ...
            <b-dropdown right size="sm" id="dropdownMenu5" variant="link" toggle-class="text-decoration-none" class="ms-auto" no-caret>
               <template #button-content> 
                  <a href="#" class="p-0 ms-auto" data-bs-toggle="dropdown" aria-expanded="false" >
                  <i class="ti-more-alt text-grey-900 btn-round-md bg-greylight font-xss" ></i > </a> 
               </template>
               <b-dropdown-item v-b-modal.editmypost v-on:click="updatePostid(item.id,itemIndex)">
                  <div class="p-0 mr-2 card-body d-flex"> <button class="pl-4 mt-0 fw-600 text-grey-900 font-xss me-4 btn"  >Edit</button> </div>
               </b-dropdown-item>
               <b-dropdown-item href="#">
                  <div class="p-0 mt-2 card-body d-flex">
                     <h4 class="pl-4 mt-0 fw-600 text-grey-900 font-xss me-4">Share</h4>
                  </div>
               </b-dropdown-item>
               <b-dropdown-item href="#">
                  <div class="p-0 mt-2 card-body d-flex"> <button type="button" class="btn pl-4 mt-0 fw-600 text-grey-900 font-xss me-4 pt-0" v-on:click="deletePosts(item.id,itemIndex)">Delete</button> </div>
               </b-dropdown-item>
            </b-dropdown>
         </div>
         <div class="row ps-2 pe-2" >
            <div class="col-xs col-sm p-1" v-for="(item,i) in item.medias" v-bind:key="item.id"> <a data-lightbox="roadtri" class="position-relative d-block"> <img :src="`${item.path}`" class="rounded-3 w-100" alt="image"  /> <span class="img-count font-sm text-white ls-3 fw-600" v-if="i==2" > <b>+{{i+0}}</b></span ></a> </div>
         </div>
         ...
         <div class="p-0 card-body d-flex">
            <b-button variant="link" class="text-decoration-none emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-2 p-0" v-b-modal.likes v-on:click="likeShow(item.id)">{{item.likes_count}} Likes</b-button>
            <a class=" d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"> <span class="d-none-xss">{{item.comments_count}}</span></a> <button type="button" class="btn p-1 d-none-xss d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss" v-on:click="commentshow(item.id)">Comments</button> 
                        ...
                        <div class="p-1 media-body bg-lightgrey fw-500">
                           <div class="d-flex justify-content-between me-0">
                              ...
                              <h5 class="mr-0 font-xsss text-grey-500 fw-500 align-items-end">
                                 ...
                                 <b-dropdown right size="sm" id="dropdownMenu5" variant="link" toggle-class="text-decoration-none" class="ms-auto" no-caret>
                                    <template #button-content> <a   class="ms-auto" data-bs-toggle="dropdown" aria-expanded="false" ><i class="mt-0 ti-more text-grey-900 bg-greylight"></i></a> </template>
      ...
      <b-modal show-close="ftrue"  hide-footer id="editmypost" centered ref="modal"  size="lg" > 
