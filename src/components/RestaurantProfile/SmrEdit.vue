<template>
   ...
   <div class="row">
      ...
      <div class="col-lg-12 mb-2">
         <div class="">
            ...
            <select style=" padding: 0.375rem 1.75rem 0.375rem 0.75rem; font-size: 1rem; " v-model="smrData.restaurant_type_id" class="form-select" aria-required="true" aria-invalid="false">
            ...
            <input   type="text" class="form-control" v-model="smrData.restaurant_type"/>
            </div>
   ...
   <div class="row">
      <div class="col-lg-4 mb-2">
         <label class="mont-font fw-600 font-xsss">Country{{smrData.country.id}}</label> 
         <select style=" padding: 0.375rem 1.75rem 0.375rem 0.75rem; font-size: 1rem; " class="form-select" aria-required="true" aria-invalid="false" v-model="smrData.country.id"  @change="getState()" >
      ...
      <div class="col-lg-4 mb-2">
         <div class="">
            ...
            <select style=" padding: 0.375rem 1.75rem 0.375rem 0.75rem; font-size: 1rem; " v-model="smrData.state.id" class="form-select" aria-required="true" aria-invalid="false"  @change="getCity()" >
      ...
      <div class="col-lg-4 mb-2">
         <div class="">
            ...
            <select style=" padding: 0.375rem 1.75rem 0.375rem 0.75rem; font-size: 1rem; " class="form-select" aria-required="true" aria-invalid="false" v-model="smrData.city.id"  >
   ...
   <div class="row">
      <div class="col-lg-4 mb-2">
         <div class="">
            ...
            <input type="text" class="form-control" v-model="smrData.operate_since"  >
         </div>
      </div>
      <div class="col-lg-4 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Runnig Or Closed</label><br/>
            <!-- <input type="text" class="form-control" v-model="smrData.is_closed"> -->
            
                  <div class="form-check form-check-inline mt-2">
  <input class="form-check-input" v-model="smrData.is_closed"  type="radio" name="inlineRadioOptions" id="inlineRadio1" value="0">
  <label class="form-check-label" for="inlineRadio1">No</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" v-model="smrData.is_closed"  type="radio" name="inlineRadioOptions" id="inlineRadio2" value="1">
  <label class="form-check-label" for="inlineRadio2">Yes</label>
      ...
      <div class="col-lg-4 mb-2">
         <div class="">
            ...
            <input type="text" class="form-control" v-model="smrData.turnover">
         </div>
      </div>
   </div>
   <div class="row">
   ...
   <div class="row">
      <div class="col-lg-6 mb-2">
         <div class="">
            ...
            <input type="text" class="form-control" v-model="smrData.expected_price" >
         </div>
      </div>
      <div class="col-lg-6 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Price Will include  List</label>
            <input type="text" class="form-control" v-model="smrData.price_include_list" >
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-12 mb-2">
         <div class="">
            ...
            <input type="text" class="form-control" v-model="smrData.contact_name" />
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-12 mb-2">
         <div class="">
            ...
            <input type="text" class="form-control" v-model="smrData.contact_phone" >
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-12 mb-2">
         <div class="">
            ...
            <input type="text" class="form-control"  v-model="smrData.contact_email">
         </div>
      </div>
   </div>
    <div class="row">
   ...
   <div class="row">
      <div class="col-lg-12 ">
         <router-link type="button" to="/SellrestEdit" style="background-color: rgb(136 143 150 / 88%) !important;" class=" font-xsssss fw-600  ps-3  pe-3 lh-32 mb-0 text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto float-right">Cancel</router-link>
         <b-button type="submit" style="background-color: #004898 !important" class=" font-xsssss fw-600  ps-3 p-2 pe-3 lh-32 mb-0 text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto float-right">Save </b-button>
      </div>
   </div>
</form>
      </div>
   ...
   <div class="row">
      ...
      <div class="col-lg-12 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Category/Type</label>
            <input type="text" class="form-control" v-model="smrData.restaurant_type_id" disabled>
         </div>
      </div>
      </div>
   <div class="row">
      <div class="col-lg-4 mb-2">
         ...
         <select style=" padding: 0.375rem 1.75rem 0.375rem 0.75rem; font-size: 1rem; " class="form-select" aria-required="true" aria-invalid="false" v-model="smrData.country_id"  @change="getState()" disabled>
            <option value="" disabled selected>Country</option>
            <option v-for="country in countrys" :value="country.id" v-bind:key="country.id" >{{country.name}}</option>
         </select>
      </div>
      <div class="col-lg-4 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">State</label> 
            <select style=" padding: 0.375rem 1.75rem 0.375rem 0.75rem; font-size: 1rem; " v-model="smrData.state.id" class="form-select" aria-required="true" aria-invalid="false"  @change="getCity()"  disabled>
               <option value="" disabled selected>State</option>
               <option v-for="item in state" :value="item.id" v-bind:key="item.id" >{{item.name}}</option>
            </select>
         </div>
      ...
      <div class="col-lg-4 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Current City</label> 
            <select style=" padding: 0.375rem 1.75rem 0.375rem 0.75rem; font-size: 1rem; " class="form-select" aria-required="true" aria-invalid="false" v-model="smrData.city.id" disabled >
               <option value="" disabled selected>City</option>
               <option v-for="item in city" :value="item.id" v-bind:key="item.id" >{{item.name}}</option>
            </select>
         </div>
   ...
   <div class="row">
      <div class="col-lg-4 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Opening Since</label>
            <input type="text" class="form-control" v-model="smrData.operate_since"  disabled>
         </div>
      </div>
      <div class="col-lg-4 mb-2">
         <!-- <div class="">
  ...
  <label class="form-check-label" for="inlineRadio1">Per Month</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input"   type="radio" name="inlineRadioOptions" id="inlineRadio2" value="1">
  <label class="form-check-label" for="inlineRadio2">Per Year</label>
</div>
      ...
      <div class="col-lg-4 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Turnover P.M</label>
            <input type="text" class="form-control" v-model="smrData.turnover" disabled>
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-6 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Cuurrent Cost P.M</label>
            <input type="text" class="form-control"  v-model="smrData.cost" disabled>
         </div>
      </div>
      <div class="col-lg-6 mb-2">
         <label class="mont-font fw-600 font-xsss">Profit Per Month</label>
         <input type="text" class="form-control" v-model="smrData.profit" disabled/>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-6 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Expected Price</label>
            <input type="text" class="form-control" v-model="smrData.expected_price" disabled>
         </div>
      </div>
      <div class="col-lg-6 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Price Will include  List</label>
            <input type="text" class="form-control" v-model="smrData.price_include_list" disabled>
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-12 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Contact Person name</label>
            <input type="text" class="form-control" v-model="smrData.contact_name" disabled/>
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-12 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Mobile No.</label>
            <input type="text" class="form-control" v-model="smrData.contact_phone" disabled >
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-12 mb-2">
         <div class="">
            <label class="mont-font fw-600 font-xsss">Email Id</label>
            <input type="text" class="form-control"  v-model="smrData.contact_email" disabled>
         </div>
      </div>
   </div>
   <div class="row">
   ...
   <div class="row">
      <div class="col-lg-12 mt-0">
         <b-button type="button" style="background-color: rgb(136 143 150 / 88%) !important;" class=" font-xsssss fw-600  ps-3 p-2 pe-3 lh-32 mt-1 mb-0 text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto float-right">Cancel</b-button>
...
photo.append('images[0]', this.smrData.photo, this.smrData.photo.name)
         ...
         photo.append('restaurant_type', this.dataOld)
           ...
           const response = await axios.post("restaurants/sell-my-restaurant/"+this.GetId, 
              photo, {
