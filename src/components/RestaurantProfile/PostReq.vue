            ...
            <div class="row">
               ...
               <div class="col-lg-12 mb-2">
                  <div class="">
                     ...
                     <textarea class="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Write your message..." spellcheck="false"  v-model="description"></textarea>
                  </div>
               </div>
            </div>
               <div class="row">
      <div class="col-lg-12 ">
         <div class="">
            ...
            <div class="row">
               ...
               <div class="col-lg-12  ">
                  <b-button type="submit" style="background-color: #004898!important" class="w-100 font-xsssss fw-700 ps-3  pe-3 lh-32  mt-1 mb-0  text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto">Create</b-button>
               </div>
            </div>
         </form>
      </div>
         ...
         <form>
            <div class="row">
               ...
               <div class="col-lg-12 mb-2">
                  <div class="">
                     <label class="mont-font fw-600 font-xsss">Description</label>
                     <textarea class="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Write your message..." spellcheck="false" disabled></textarea>
                  </div>
               </div>
            </div>
            <div class="row">
                  ...
                  <div class="card mt-3 border-0">
                     <div class="card-body d-flex justify-content-between align-items-end p-0">
                        <div class=" mb-2 w-100">
                           <input type="file" name="file" id="file" class="input-file" disabled>
               ...
               <div class="col-lg-12 mt-2">
                  <b-button type="submit" style="background-color: #004898!important" class="font-xsssss fw-700 ps-3 p-3 pe-3 lh-32  mt-1 mb-0  text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto" disabled>Create</b-button>
               </div>
            </div>
         </form>
      </div>
