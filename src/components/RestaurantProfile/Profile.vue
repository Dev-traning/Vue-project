        ...
        <div class="middle-sidebar-bottom" style="background-color: #FAFAFA;">
          <div class="middle-sidebar-left">
            <div class="row">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <li class="list-inline-item me-5">
                        <router-link
                          :to="'/Profile/' + current_id + '/Following'"
                        >
                          <b-button
                            variant="link"
              ...
              <div>
                <Followers :current_id="this.current_id" />
              </div>
              <!-- <div>
  ...
  methods: {
    ...
    unfollow() {
      ...
      axios
        ...
        .then((response) => {
          console.log(response);
          this.list.relation = "Follow";
        });
    },
    withdraw() {
      this.searID = this.$route.params.id;
      axios
        .post("users/cancelRequest", {
          followee_id: this.searID,
        })
        .then((response) => {
          console.log(response);
