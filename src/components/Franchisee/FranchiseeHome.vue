...
<div v-if="this.users.user_type === '6'" >
   ...
   <div class="row">
                ...
                <div class="col-12"  v-for="item in franchise.slice(0,2)" v-bind:key="item.id">
                                 <div class="p-1 mb-3 overflow-hidden bg-white border-0 card w-100 hover-card shadow-xss rounded-xxl" >
                                    <div class="card-image w-100"> 
 
                                         <img :src="item.medias.path" alt="event" class="w-100" width="250.5" height="187.88" v-if="item.medias.path"/> 
                                    ...
                                    <div class="pb-0  mt-1 ps-0 pe-0">
                                       <div class="p-0 bg-greylight border-light-md rounded-xxl theme-dark-bg" >
                                          <h4 class="pl-3 mb-0 fw-700 font-xss ls-3 lh-27 text-grey-800" > {{item.restaurant.name}} <span class=" ls-3 d-block font-xsssss text-grey-500 fw-500" >12 Jan, 2021</span ></h4>
                                       </div>
                                       
                                          <h4 class="mt-2 text-center font-xssss fw-500 text-grey-500">
                                              <span class="d-block lh-25 mb-1">api side not showing comment</span>
  ...
  import axios from "axios";
   export default {
    ...
    getData() {
      ...
      axios.get("restaurants/give-franchise?per_page=2&page=1")
