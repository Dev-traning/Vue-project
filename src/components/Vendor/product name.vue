         ...
         <form @submit.prevent="handalSubmit" enctype="multipart/form-data">
            ...
            <div class="row">
               <div class="col-lg-12 mb-0">
                  <label class="mont-font fw-600 font-xsss">List Your Product With Rates</label>
               </div>
               <div class="row" v-for="(input,k,) in vendor.product_name" :key="k">
 
                  <div class="col-lg-6  mb-2">
                     <input type="text"   class="form-control"  placeholder="Product Name" v-model="input.name" />
                  </div>
                  <div class="col-lg-4 mb-2">
                     <input type="text"   class="form-control" placeholder="Product Rate" v-model="input.rate" />
                  </div>
                  <div class="col-lg-2 mb-2">
                     <i class="feather-trash-2 font-lg btn-round-sm me-2 p-0 btn btn-light" @click="remove(k)" v-show="k || ( k && vendor.product_name.length > 1)"></i>
                     <i class="feather-plus font-lg btn-round-sm me-2 p-0 btn btn-light" @click="add(k)" v-show="k == vendor.product_name.length-1"></i>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-lg-12 mb-2">
                  <div class="">
                     <label class="mont-font fw-600 font-xsss">Can Provide Goods How Much Time</label>
                     <input
                        type="text"
                        class="form-control"
