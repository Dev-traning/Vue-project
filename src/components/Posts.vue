    ...
    <div class="card-body p-0 mt-0 position-relative">
      ...
      >
        <button
          @click="modelClose()"
          type="button"
          class="closee mt-1 flex justify-content-end"
          data-dismiss="modal"
          aria-label="Close"
        >
        ...
        <div class="modal-header pl-4 m-0 pb-0">
          <h2
            style="color: #004898!important"
            class="modal-title my-2 mt-3 text-uppercase font-weight-bolder text-blue"
          >
            Create Post
          </h2>
        </div>
        <form ref="form" v-on:submit.prevent="handalSubmit" class="pb-3 pt-2">
          ...
          >
            <b-form-input
              class=" rounded-xxl p-2 ps-2 font-xss text-grey-500 fw-500 border-light-md mb-3"
              id="name-input"
              v-model="title"
            ></b-form-input>
          </b-form-group>
          ...
          >
            <b-form-input
              class="mb-3 rounded-xxl p-2 ps-2 font-xss text-grey-500 fw-500 border-light-md mb-0 mt-0"
              id="name-input"
              v-model="location"
            ></b-form-input>
          </b-form-group>
          ...
          >
            <textarea
              name="message"
              v-model="description"
              class="mb-3 h100 bor-0 w-100 rounded-xxl p-2 ps-2 font-xss text-grey-500 fw-500 border-light-md theme-dark-bg"
              cols="30"
              rows="10"
              placeholder="What's on your mind?"
            ></textarea>
          ...
          <div class="card-body d-flex p-0 mb-2">
            <a
              href="#"
            ...
            >
              <div class="left mb-3">
                <label class="file">
                  ...
                  <span class="d-none-xs font-xss">Photo</span>
                  <input
                    type="file"
                    class="images[]"
                    name="images"
                    id="file-small"
                    @change="
                      imageupload($event.target.name, $event.target.files)
                    "
                    multiple
                    accept="image/*"
                  />
          ...
          <b-button
            ...
            class="font-xsss fw-700 ps-3 pe-3 lh-32 mt-1 mb-0 text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto w-100"
            >{{ loading ? "Loading..." : "Post" }}</b-button
          >
        </form>
      </b-modal>
    </div>
...
<style>
div div #modal-center___BV_modal_content_ {
  width: 1000px;
}
