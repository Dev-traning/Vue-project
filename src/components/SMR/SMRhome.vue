<template>
  <div>
    <div
      class="card w-100 shadow-xss rounded-0 border-0 mb-3 ml-3 sticky-top m-class"
    >
      <div class="card-body d-flex align-items-center p-3">
        <h4
          class="fw-700 mb-0 font-xssss text-grey-900"
          v-if="this.users.user_type === '6'"
        >
          Sale My Restaurant
        </h4>
        <h4
          class="fw-700 mb-0 font-xssss text-grey-900"
          v-else-if="this.users.user_type === '8'"
        >
          Restaurant
        </h4>
        <h4 class="fw-700 mb-0 font-xssss text-grey-900" v-else>
          Requirment Posted
        </h4>
        ...
        >
          ...
          <router-link
            class="text-primary"
            v-else-if="this.users.user_type === '7'"
              ...
              <div class="pb-0 mt-1 ps-0 pe-0">
                ...
                <h4 class="mt-2 text-center font-xssss fw-500 text-grey-500">
                  <span class="d-block lh-25 mb-1"
                    >Comment Data Not showing This API</span
                  >
    ...
    <div class="row" v-if="this.users.user_type === '8'">
      <div class="container">
        <div class="row">
          <div
            class="ml-3 col-12"
            v-for="item in restauraData.slice(0, 2)"
            v-bind:key="item.id"
          >
            <div
              class="p-1 mb-3 overflow-hidden bg-white border-0 card w-100 hover-card shadow-xss rounded-xxl"
    ...
    <div class="row" v-else>
      <div class="container">
        <div class="row">
          <div
            class="ml-3 col-12"
            v-for="item in requirements.slice(0, 2)"
            v-bind:key="item.id"
          >
            <div
              class="p-1 mb-3 overflow-hidden bg-white border-0 card w-100 hover-card shadow-xss rounded-xxl"
  ...
  methods: {
    getData() {
      ...
      if (this.user.user_type === "6") {
        axios
          .get("restaurants/sell-my-restaurant?per_page=2&page=1")
      ...
      if (this.user.user_type === "7") {
        axios
          .get("restaurants/requirement?per_page=2&page=1")
