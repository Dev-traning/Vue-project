            ...
            <div class="row">
                <div class="col-sm-12 ">
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4">
                        ...
                        <form @submit.prevent="handalSubmit" id="dsa" enctype="multipart/form-data">
                            ...
                            <div class="row ">
                                <div class="col-lg-6 ">
                                    <div class="">
                                        ...
                                        <input id="iban" type="text" name="iban" class="form-control" v-model="aadharcard_number">
                                    </div>
                                </div>
                                <div class="col-lg-6 ">
                                    <div class="">
      ...
      <th  scope="row">{{+noOfcoupon * +mrp / 100 * 18 + +noOfcoupon * +mrp}}</th>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-2 text-center">
                                    <b-button type="submit" style="background-color: #004898 !important" class=" font-xsssss fw-600  ps-3   pe-3 lh-32 mt-1 mb-0   rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto ">{{loading ? "Processing..." : "Submit"}}</b-button>
