              ...
              <div class="col-xl-3 col-xxl-2 col-lg-3 ps-lg-0">
                ...
                <!-- <div class="row">
                        <div class="container">
                           <div class="row">
                              <div class="col-12">
                                 <div class=" card p-3 bg-white w-100 hover-card border-0 shadow-xss rounded-xxl border-0 mb-3 overflow-hidden ml-3" >
                                    <div class="card-image w-100"> <img src="../../assets/images/e-6.jpg" alt="event" class="w-100 rounded-3"/> </div>
                              ...
                              <div class="col-12">
                                 <div class=" card p-3 bg-white w-100 hover-card border-0 shadow-xss rounded-xxl border-0 mb-3 overflow-hidden ml-3" >
                                    <div class="card-image w-100"> <img src="../../assets/images/e-5.jpg" alt="event" class="w-100 rounded-3"/> </div>
                                    <div class="card-body d-flex ps-0 pe-0 pb-0">
                                       <div class=" bg-greylight me-3 p-3 border-light-md rounded-xxl theme-dark-bg " >
                                          <h4 class="fw-700 font-lg ls-3 text-grey-900 mb-0" > <span class=" ls-3 d-block font-xsss text-grey-500 fw-500 " >FEB</span >22 </h4>
                                       </div>
                  ...
                  <div class="p-4  border-0 card w-100 shadow-xss rounded-xxl">
                    <div class="d-flex">
                      <div class="p-0 card-body d-flex">
                        <figure class="avatar me-3">
                          <img
                            :src="`${postSingle.user.profile_photo}`"
                            alt="image"
                            height="45"
                            class="shadow-sm rounded-circle w45"
                            v-if="postSingle.user.profile_photo"
                          />
                          <img
                        ...
                        <h4 class="fw-700 text-grey-900 font-xssss mt-1">
                          {{ postSingle.user.full_name
                          }}<span
                            class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500"
                            >{{ moment(postSingle.created_at).fromNow() }}</span
                          >
                        </h4>
                      </div>
                      <div class="ml-auto ">
                        ...
                        >
                          ...
                          <b-dropdown-item href="#">
                            <div class="p-0 mt-2 card-body d-flex">
                              <h4
                                class="pl-4 mt-0 fw-600 text-grey-900 font-xss me-4"
                              >
                                Copy Link
                              </h4>
                            </div>
                          ...
                          <b-dropdown-item href="#">
                            <div class="p-0 mt-2 card-body d-flex">
                              <button
                                ...
                                v-on:click="deletePosts(item.id, index)"
                              >
                                Delete
                              </button>
                            </div>
                    ...
                    <div class="row ps-2 pe-2">
                      <div
                        ...
                        v-for="(item, i) in postSingle.medias"
                        v-bind:key="item.id"
                      >
                        <a
                    ...
                    <div
                      v-for="commentsshow in comments"
                          ...
                          <li class="mb-2 media">
                            ...
                            <div class="p-1 media-body bg-lightgrey fw-500">
                              <div class="d-flex justify-content-between me-0">
                                <h3
                                  class="mt-3 fw-700 text-grey-900 font-xsss mb-0"
                                >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <b-dropdown-item
                                      v-on:click="commentedit(commentsshow.id)"
                        ...
                        >
                          ...
                          <td>
                            <button
                              ...
                              v-on:click="
                                followlike(likeusers.user_id, folloind)
                              "
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="card-body d-flex p-0 mt-2 mb-2">
                        ...
                        <div class="img-wrap  d-flex">
                          <div
                            v-for="(img, index) in singlepost.medias"
                            :key="img.id"
                          >
                            <b-img
                              class="p-1"
...
export default {
  ...
  methods: {
    ...
    likepost() {
      axios.post("posts/like/" + this.$route.params.id).then((result) => {
    ...
    async commentupdate() {
      const response = axios
        .post("comments/" + this.$route.params.id, {
