            ...
            <div class="middle-sidebar-left">
               <div class="row">
                                   ...
                                   <div class="col-lg-4">
                                       ...
                                       <div class="w-100">
                                                   ...
                                                   <label for="file">
                                                           ...
                                                           <img  title="Change Profile Photo"   :src="`${user.profile_photo}`" width="90px" height="90px" class="overflow-hidden shadow-sm rounded-xxxl" alt="Change Profile Photo" v-if="user.profile_photo">
                  ...
                  <div class="col-xl-9 col-xxl-10 col-lg-9">
                    ...
                    <div v-if="!user.is_subscribed"><Search/></div>
       ...
       <div class="col-xl-3 col-xxl-2 col-lg-3 ps-lg-0  ">
                  ...
                  <div class="col-xl-3 col-xxl-2 col-lg-3 ps-lg-0">
                     ...
                     <div class="row">
                        ...
                        <div class="mt-0"><span   class="space1" style="color: rgb(0, 72, 152);">Restro</span><span  class="space1" style="color: rgb(196, 30, 22);">world</span> Corporation © 2021</div>
                     </footer>
