    ...
    >
      <form ref="form" @submit.prevent="handalSubmit">
        ...
        <b-button
          ...
          class="font-xsssss fw-700 ps-3 pe-3 lh-32  mt-1 mb-0  text-uppercase rounded-3 ls-2 bg-success d-inline-block text-white me-1 ms-auto"
          >Post</b-button
        >
      </form>
    </div>
...
export default {
  ...
  methods: {
    async handalSubmit() {
      const response = await axios.post("posts/comment/21", {
        body: this.body,
      });
