      ...
      <div>
        ...
        >
          <div class="text-center">
            <b style="font-size: 50px !important; "
              ><span class="space1" style="color: #004898">Restro</span
              ><span class="space1" style="color: #c41e16">world</span></b
            >
            <p
              style="color: black; font-size: 14px; margin-left: 4px; margin-top: -18px; font-weight: bold;"
              class=""
            >
              India's First Global Restaurant Community
            </p>
            <a href="#"
              ><h3
          ...
          <form
            ref="form"
            class="pl-5 pr-5"
            v-on:submit.prevent="paymentcreate"
          >
            <b-form-group
              class=" mb-2 mt-0"
              label="Business Name"
            ...
            >
              <b-form-input
                ...
                id="name-input"
                v-model="users.restaurant.business_name"
                autocomplete="off"
              ></b-form-input>
            </b-form-group>
            <div class="row">
            ...
            <div v-if="isHidden" class="promo-box">
              <div class="input-group ">
                ...
                <div class="input-group-append" v-if="!coupon">
                  <b-button class="subscribe-button" v-on:click="applyCoupon()"
                    >Apply</b-button
                  >
                </div>
            ...
            >
              <b-form-input
                ...
                id="name-input"
                placeholder="Rs.999.00/-"
                autocomplete="off"
                v-if="coupon"
                v-model="coupon.data.amount_pay"
                disabled
              ></b-form-input>
          ...
          >
            ...
            <input
              type="hidden"
              name="surl"
              value="http://localhost:3000/PaymentStatus"
              size="64"
            />
            <input
              type="hidden"
              name="furl"
              value="http://localhost:3000/home/User/Fail"
              size="64"
            />
            <input
              type="hidden"
