  ...
  <div>
    ...
    <div class="panel panel-default" v-if="searchQuery">
      <div
        ...
        style="position: absolute;z-index:1000; border:1px solid #ccc; background:#fff; "
      >
        <p
          v-for="item in resultQuery.slice(0, 15)"
          :key="item.id"
          style=" margin: -1px 0 0 0;font-size: 14px;color: #333;list-style: none;background-color: #fff; background-clip:padding-box;  border-radius: 0 0 3px 3px; max-height: 350px; overflow-y: auto; box-shadow: 2px 2px 4px rgb(0 0 0 / 8%), inset 0 0 0 0.6px #d2d2d2; padding: 0.75px;"
        >
          <a
