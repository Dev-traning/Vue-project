                          ...
                          <div class=" p-4 pt-0">
                            <div class="payment">
                              ...
                              <div class="content">
                                ...
                                >
                                  Restroworld is the first global community
                                  specially designed for the Restaurant
                                  Industry. This is the first global platform
                                  where every single business head from the
                                  industry can find each and every kind of
                                  Restaurant Solution. If you are a Restaurant,
                                  you will get million of vendors across the
                                  globe here and if you are a vendor, you will
                                  get millions of restaurants to have the trade.
                                  So, wel-come to the World of Restaurants,
                                  i.e., Restroworld.
                                </p>
                                <!-- <p
                                  class="  font-xssss  fw-500 text-justify mb-1"
